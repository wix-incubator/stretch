        ...
        .new_node(
            stretch::style::Style {
                ...
                grid_template: stretch::style::GridTemplate {
                    rows: vec![stretch::style::TrackSizingFunction::Inflexible(
                        stretch::style::InflexibleSize::Points(100f32),
                    )],
                    columns: vec![
                        stretch::style::TrackSizingFunction::Inflexible(stretch::style::InflexibleSize::Points(30f32)),
                        stretch::style::TrackSizingFunction::Inflexible(stretch::style::InflexibleSize::Points(70f32)),
                    ],
                },
