#[test]
fn display_grid_negative_grid_area() {
            ...
            stretch::style::Style {
                ...
                grid_item: stretch::style::GridItem {
                    ...
                    column: stretch::style::GridItemPlacement::ImplicitSpan {
                        start: stretch::style::GridLine::FromEnd(1u16),
                        end: stretch::style::GridLine::FromEnd(1u16),
                    },
                },
                ..Default::default()
            },
        ...
        .new_node(
            stretch::style::Style {
                ...
                grid_item: stretch::style::GridItem {
                    ...
                    column: stretch::style::GridItemPlacement::ImplicitSpan {
                        start: stretch::style::GridLine::FromEnd(2u16),
                        end: stretch::style::GridLine::FromEnd(2u16),
                    },
                },
                ..Default::default()
            },
